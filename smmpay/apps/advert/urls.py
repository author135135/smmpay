...
urlpatterns = [
    ...
    url(r'^offer/(?P<pk>[0-9]+)/add-to-favorites/$', views.AdvertAddToFavoritesView.as_view(),
        name='add_to_favorites'),
    url(r'^offer/(?P<pk>[0-9]+)/delete-from-favorites/$', views.AdvertDeleteFromFavoritesView.as_view(),
