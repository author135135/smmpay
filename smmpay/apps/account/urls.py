...
urlpatterns = [
    ...
    url(r'^ad/(?P<pk>[0-9]+)/deactivate/$', views.AdvertDeactivateView.as_view(), name='advert_deactivate'),
    url(r'^ad/(?P<pk>[0-9]+)/activate/$', views.AdvertActivateView.as_view(), name='advert_activate'),
