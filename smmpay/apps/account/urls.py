...
urlpatterns = [
    ...
    url(r'^advert/(?P<pk>[0-9]+)/deactivate/$', views.AdvertDeactivateView.as_view(), name='advert_deactivate'),
    url(r'^advert/(?P<pk>[0-9]+)/activate/$', views.AdvertActivateView.as_view(), name='advert_activate'),
    ...
    url(r'^discussion/(?P<pk>[0-9]+)/add-views/$', views.DiscussionAddViewsView.as_view(), name='discussion_add_view'),
